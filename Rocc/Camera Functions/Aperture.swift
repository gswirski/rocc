...
extension Aperture.Value: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard let value = try? values.decode(Double.self, forKey: .v) else {
            throw DecodingError.dataCorrupted(DecodingError.Context(codingPath: [CodingKeys.v], debugDescription: "value cannot be nil"))
        }

        let decimalSeparator = try? values.decode(String.self, forKey: .s)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(decimalSeperator, forKey: .s)
    }
}
