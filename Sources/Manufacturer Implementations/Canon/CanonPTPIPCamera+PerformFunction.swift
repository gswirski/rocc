        ...
        while (pointer + 8 <= dataSize) {
            ...
            case .PTP_EC_CANON_EOS_OLCInfoChanged:
                ...
                if (mask & 0x0020) != 0 { // SELF TIMER?
                    ...
                    Logger.log(message: "Intervalometer - OLC(0x0020 self timer) - \(data.toHex)", category: "PTPIPClient", level: .debug)
                    olcOffset += 6
                }
                if (mask & 0x0040) != 0 { // EXPOSURE INDICATOR
                    ...
                    Logger.log(message: "Intervalometer - OLC(0x0040 metering) - \(data.toHex)", category: "PTPIPClient", level: .debug)
                    olcOffset += 8
                }
                if (mask & 0x0080) != 0 { // UNKNOWN
                    ...
                    Logger.log(message: "Intervalometer - OLC(0x0080 unknown) - \(data.toHex)", category: "PTPIPClient", level: .debug)
                    olcOffset += 4
                }
                if (mask & 0x0100) != 0 { // FOCUS INFO
                    ...
                    Logger.log(message: "Intervalometer - OLC(0x0100 focus info) - \(data.toHex)", category: "PTPIPClient", level: .debug)
                    olcOffset += 7
                }
                if (mask & 0x0200) != 0 { // FOCUS MASK?
                    ...
                    Logger.log(message: "Intervalometer - OLC(0x0200 focus mask A?) - \(data.toHex)", category: "PTPIPClient", level: .debug)
                    olcOffset += 7
                }
                if (mask & 0x0400) != 0 { // FOCUS MASK?
                    ...
                    Logger.log(message: "Intervalometer - OLC(0x0400 focus mask B?) - \(data.toHex)", category: "PTPIPClient", level: .debug)
                    olcOffset += 7
                }
                if (mask & 0x0800) != 0 { // FOCUS MASK?
                    ...
                    Logger.log(message: "Intervalometer - OLC(0x0800 focus mask B?) - \(data.toHex)", category: "PTPIPClient", level: .debug)
                    olcOffset += 8
                }
