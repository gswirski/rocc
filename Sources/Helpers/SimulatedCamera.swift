...
public final class DummyCamera: Camera {
    ...
    private var currentShutterSpeed: ShutterSpeed = .userDefined(value: ShutterSpeed.Value(numerator: 1.0, denominator: 1250, id: 0))
    
    private var currentAperture: Aperture.Value = .userDefined(value: 1.8, id: 0)
    ...
    public func isFunctionAvailable<T>(_ function: T, callback: @escaping ((Bool?, Error?, [T.SendType]?) -> Void)) where T : CameraFunction {
        ...
        case .setShutterSpeed:
            callback(true, nil, [
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 8000, id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 6000, id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 3000, id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 2000, id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 1250, id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 1000, id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 600 , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 400 , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 200 , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 100 , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 50  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 20  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 10  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 5   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 4   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 3   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 2   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 1   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 2, denominator: 1   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 3, denominator: 1   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 4, denominator: 1   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 5, denominator: 1   , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 10, denominator: 1  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 12, denominator: 1  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 16, denominator: 1  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 18, denominator: 1  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 20, denominator: 1  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 25, denominator: 1  , id: 0)),
                ShutterSpeed.userDefined(value: ShutterSpeed.Value(numerator: 30, denominator: 1  , id: 0)),
                ShutterSpeed.bulb
            ] as? [T.SendType])
    ...
    private func constructCurrentEvent() -> CameraEvent {
        ...
        return CameraEvent(
            ...
            aperture: (
                ...
                available: [
                    .userDefined(value: 1.8, id: 0),
                    .userDefined(value: 2.0, id: 0),
                    .userDefined(value: 2.2, id: 0),
                    .userDefined(value: 2.8, id: 0),
                    .userDefined(value: 3.2, id: 0),
                    .userDefined(value: 4.0, id: 0),
                    .userDefined(value: 4.8, id: 0),
                    .userDefined(value: 5.6, id: 0),
                    .userDefined(value: 8.0, id: 0),
                    .userDefined(value: 11.0, id: 0),
                    .userDefined(value: 18.0, id: 0),
                    .userDefined(value: 22.0, id: 0)
                ],
                supported: [
                    .userDefined(value: 1.8, id: 0),
                    .userDefined(value: 2.0, id: 0),
            ...
            shutterSpeed: (current: currentShutterSpeed, available: [
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 8000, id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 6000, id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 3000, id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 2000, id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 1250, id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 1000, id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 600 , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 400 , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 200 , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 100 , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 50  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 20  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 10  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 5   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 4   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 3   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 2   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 1, denominator: 1   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 2, denominator: 1   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 3, denominator: 1   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 4, denominator: 1   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 5, denominator: 1   , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 10, denominator: 1  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 12, denominator: 1  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 16, denominator: 1  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 18, denominator: 1  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 20, denominator: 1  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 25, denominator: 1  , id: 0)),
                .userDefined(value: ShutterSpeed.Value(numerator: 30, denominator: 1  , id: 0)),
                .bulb
                ], supported: []),
